...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new PvZ2(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("PlantsVsZombies2");
        ...
        //// The real window/taskbar icon is set at runtime from assets/textures/ui/zombie_head.png
        //// (see PvZ2.applyWindowIcon) so the green-screen background can be chroma-keyed out.
