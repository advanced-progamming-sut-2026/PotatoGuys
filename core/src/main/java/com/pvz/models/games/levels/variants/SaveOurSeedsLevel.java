...
public class SaveOurSeedsLevel extends Level {
    ...
    public SaveOurSeedsLevel(GameMapDefinition gameMap, int levelNumber, LevelType type, int initialSun,
            List<Wave> waves) {
        super(GameModeType.SAVEOURSEEDS, gameMap, levelNumber, type, initialSun);
        this.waves = waves;
    }
