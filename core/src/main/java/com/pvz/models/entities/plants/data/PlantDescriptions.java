...
/**
 * Static flavor text copied verbatim from the reference project (phase-o-group-51)
 * for the plants present in this game: plant-food effect, overall description and a
 * fun quote, as shown in the collection/almanac details view.
 */
public final class PlantDescriptions {

    private PlantDescriptions() {
    }

    public record Descriptions(String plantFood, String overall, String fun) {
    }
