...
public enum ProjectileType {
    PEA("768/INITIAL/EFFECTS/T_PEA_PROJECTILE/T_PEA_PROJECTILE.PAM", "animation", 1f , 
        "768/INITIAL/EFFECTS/SPLAT_PEA/SPLAT_PEA.PAM", "animation", 1f),
    REAPETER_PEA("768/INITIAL/EFFECTS/REPEATER_PLANTFOOD_GIANTPEA/REPEATER_PLANTFOOD_GIANTPEA.PAM","animation",
        0.8f , "768/INITIAL/EFFECTS/SPLAT_PEA/SPLAT_PEA.PAM", "animation", 1f),
    PEAPOD_GIANT_PEA("768/FULL/EFFECTS/PEAPOD_PLANTFOOD_GIANTPEA/PEAPOD_PLANTFOOD_GIANTPEA.PAM","animation",
        0.8f , "768/INITIAL/EFFECTS/SPLAT_PEA/SPLAT_PEA.PAM", "animation", 1f),
    ...
    FIRE_PEA("768/INITIAL/EFFECTS/T_FIRE_PEA/T_FIRE_PEA.PAM", "animation",
        "768/INITIAL/EFFECTS/T_SPLAT_FIRE_PEA/T_SPLAT_FIRE_PEA.PAM", "animation", 1f),
    GOO_PEA("768/INITIAL/EFFECTS/GOOPEASHOOTER_PROJECTILES/GOOPEASHOOTER_PROJECTILES.PAM", "projectile_t1",
        null, null, 1f),
    GOO_PLANTFOOD_PEA("768/INITIAL/EFFECTS/GOOPEASHOOTER_PLANTFOOD/GOOPEASHOOTER_PLANTFOOD.PAM", "animation", 0.65f,
        null, null, 1f),
    ...
    SPORE("768/INITIAL/EFFECTS/T_SPORESHROOM_PROJECTILE/T_SPORESHROOM_PROJECTILE.PAM", "animation",
        "768/FULL/EFFECTS/T_SPORESHROOM_PROJECTILE/T_SPORESHROOM_PROJECTILE.PAM", "hit", 1f),
    SEASHROOM_PROJECTILE("768/FULL/EFFECTS/SEASHROOM_PROJECTILE/SEASHROOM_PROJECTILE.PAM" , "animation",
        "768/FULL/EFFECTS/SEASHOOTER_FX/SEASHOOTER_FX.PAM", "animation", 1f),
    PUFFSHROOM_PROJECTILE("768/INITIAL/EFFECTS/T_PUFFSHROOM_PROJECTILE/T_PUFFSHROOM_PROJECTILE.PAM" , "animation",
        "768/INITIAL/EFFECTS/T_PUFFSHROOM_HIT/T_PUFFSHROOM_HIT.PAM", "animation", 1f),
    STAR("768/INITIAL/EFFECTS/T_STARFRUIT_PROJECTILE/T_STARFRUIT_PROJECTILE.PAM", "animation",
        "768/INITIAL/EFFECTS/T_STARFRUIT_PROJECTILE_HIT/T_STARFRUIT_PROJECTILE_HIT.PAM", "idle", 1f),
    ...
    CITRON_BALL("768/FULL/EFFECTS/CITRON_CITRUS_ORB/CITRON_CITRUS_ORB.PAM", "Citron_Citrus_Orb",
        null, null, 1f),
    CITRON_PLANTFOOD_ORB("768/FULL/EFFECTS/CITRON_PLANTFOOD_ORB/CITRON_PLANTFOOD_ORB.PAM", "Plantfood_Citron_Plasma_Orb",
        0.8f, "768/FULL/EFFECTS/CITRON_PLANTFOOD_HIT/CITRON_PLANTFOOD_HIT.PAM", "animation", 1f),
    CAULIPOWER_BOLT("768/INITIAL/EFFECTS/CAULIPOWER_PROJECTILE/CAULIPOWER_PROJECTILE.PAM", "animation",
        null, null, 1f),
    CAULIPOWER_PF_BOLT("768/INITIAL/EFFECTS/CAULIPOWER_PROJECTILE/CAULIPOWER_PROJECTILE.PAM", "animation3",
        null, null, 1f),
    BOWLINGBULB_PROJ1("768/FULL/EFFECTS/BOWLINGBULB_PROJECTILE1/BOWLINGBULB_PROJECTILE1.PAM", "animation",
        null, null, 1f),
    BOWLINGBULB_PROJ2("768/FULL/EFFECTS/BOWLINGBULB_PROJECTILE2/BOWLINGBULB_PROJECTILE2.PAM", "animation",
        null, null, 1f),
    BOWLINGBULB_PROJ3("768/FULL/EFFECTS/BOWLINGBULB_PROJECTILE3/BOWLINGBULB_PROJECTILE3.PAM", "animation",
        null, null, 1f),
    BOWLINGBULB_PF_PROJ("768/FULL/EFFECTS/BOWLINGBULB_PLANTFOOD_PROJECTILE/BOWLINGBULB_PLANTFOOD_PROJECTILE.PAM", "animation",
        null, null, 1f),
    ...
    MELON("768/INITIAL/EFFECTS/T_MELON_PROJECTILE/T_MELON_PROJECTILE.PAM", "animation", 0.5f,
        "768/INITIAL/EFFECTS/T_SPLAT_MELONPULT/T_SPLAT_MELONPULT.PAM", "animation", 1f),
    WINTER_MELON("768/FULL/EFFECTS/T_WINTERMELON_PROJECTILE/T_WINTERMELON_PROJECTILE.PAM", "animation", 0.5f,
        "768/FULL/EFFECTS/T_SPLAT_WINTERMELON/T_SPLAT_WINTERMELON.PAM", "animation", 1f),
    CABBAGE("768/INITIAL/EFFECTS/T_CABBAGEPULT_PROJECTILE/T_CABBAGEPULT_PROJECTILE.PAM", "animation", 0.5f,
