...
public class GraveBuster extends Plant {
    ...
    public GraveBuster(PlantPropertySheet sheet, PlantAction attackAction, PlantAction feedAction, int col, int lane, int level, boolean boosted, GameContext context) {
