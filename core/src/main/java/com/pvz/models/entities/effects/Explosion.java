...
public class Explosion extends Effect {
    private static final String POTATO_MINE_EXPLOSION_PAM_PATH =
            "768/INITIAL/EFFECTS/POTATOMINE_EXPLOSION/POTATOMINE_EXPLOSION.PAM";
    private static final String PRIMAL_POTATO_MINE_EXPLOSION_PAM_PATH =
            "768/INITIAL/EFFECTS/ESCAPEROOT_EXPLOSION_PRIMALPOTATOMINE/"
            + "ESCAPEROOT_EXPLOSION_PRIMALPOTATOMINE.PAM";
    ...
    public List<FrameConfig> draw() {
        ...
        frameConfigs.add(new FrameConfig(pamPath, clip, stateTime, pos, new Vector2(0.65f, 0.65f), null, false));
        return frameConfigs;
    }
