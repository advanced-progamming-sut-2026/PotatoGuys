 ...
 * </ul>
 *
 * <p>Follows the same parabolic math as {@link LobbedMotionState} but is
...
public class OctopusProjectile extends Entity {
    ...
    public FrameConfig draw() {
        return new FrameConfig(PAM_PATH, CLIP, stateTime,
    ...
    private void onLand() {
        ...
        for (var b : tile.getBehaviors()) {
            if (b instanceof OctopusOverlayBehavior) return;
        }
