 ...
 *
 * <p>
 * Plays three clips back-to-back, exactly like the in-game sandstorm:
 * <ol>
...
public class SandstormCloudEffect extends Effect {
    ...
    /**
     * True once the intro has finished forming, i.e. it's safe to start moving the
     * rider.
     */
    ...
    public List<FrameConfig> draw() {
        ...
        frameConfigs.add(new FrameConfig(SAND_STORM_PAM_PATH, clip, clipTime, pos, SCALE, null, looping));
        return frameConfigs;
    }
}
