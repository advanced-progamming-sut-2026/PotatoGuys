...
public class Constants {
    ...
    public static final String PLANT_ACTIONS_PATH = "resources/plant_actions.json";
     ...
     */
    public static final String ZOMBIE_ACTIONS_PATH = "resources/zombie_actions.json";
}
