...
public class QuestFactory {
        ...
        public static QuestLog createDefaultQuests() {
                ...
                addSunAndChapterQuests(log);
                addPlantAndCactusQuests(log);
                addModeAndMilestoneQuests(log);
                addConstraintAndGridQuests(log);
                addLawnmowingQuests(log);

                return log;
        }

        private static void addSunAndChapterQuests(QuestLog log) {
                // 1. Daily Sun Catcher
                ...
                for (String chapter : chapters) {
                        Quest q = new Quest("main_chapter_hunter_" + chapter.replace(" ", "_"),
                                        "Chapter Hunter: " + chapter,
        ...
        private static void addModeAndMilestoneQuests(QuestLog log) {
        ...
        private static void addConstraintAndGridQuests(QuestLog log) {
                addBasicConstraintQuests(log);
                addFamilyConstraintQuests(log);
                addGridBoundaryQuests(log);
        }

        private static void addBasicConstraintQuests(QuestLog log) {
        ...
        private static void addFamilyConstraintQuests(QuestLog log) {
                ...
                for (String family : families) {
                        ...
                        Quest qConstraints = new Quest("daily_blooming_constraints_" + family,
                                        "Blooming in Constraints",
        ...
        private static void addGridBoundaryQuests(QuestLog log) {
                for (int c = 0; c < 9; c++) {
        ...
        private static void addLawnmowingQuests(QuestLog log) {
                // 20. Lawnmowing Time
