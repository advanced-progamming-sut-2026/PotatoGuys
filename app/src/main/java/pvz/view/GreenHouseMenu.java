...
public class GreenHouseMenu implements Menu {
    ...
    public Result handleInput(String input) {
        ...
        Matcher matcher;
        if ((matcher = GreenHouseMenuCommands.ENTER_MENU.getMatcher(input)) != null)
            return controller.showGreenhouse(matcher);
        if ((matcher = GreenHouseMenuCommands.PLANT.getMatcher(input)) != null)
            return controller.plant(matcher);
        if ((matcher = GreenHouseMenuCommands.COLLECT.getMatcher(input)) != null)
        ...
        if ((matcher = GreenHouseMenuCommands.HELP.getMatcher(input)) != null)
            return new Result(GreenHouseMenuCommands.getHelp());
